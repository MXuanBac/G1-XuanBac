...
public class Main {
    ...
    public static void sortByAge() {
        StudentComparator ageComparator = (s1, s2) -> Integer.compare(s1.getAge(), s2.getAge());
    ...
    public static void sortByGPA() {
        StudentComparator gpaComparator = (s1, s2) -> Double.compare(s1.getGpa(), s2.getGpa());
    ...
    public static void sortStudentsByAgeThenGpa() {
        StudentComparator ageThenGpaComparator = (s1, s2) -> {
    ...
    public static void sort5() {
        StudentComparator sortFive = (s1, s2) -> {
